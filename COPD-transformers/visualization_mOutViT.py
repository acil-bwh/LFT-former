...
from Utils.visualization.plots_mOutViT import Confusion_mOutViT, OneOff_mOutViT
import argparse
...
save_path = main_path+project_name+'-results/figures/mOutViT'
import os
...
how = "concat"
num_slices = 20
print(f"\nResults LFT {output_type} using {input_type} with {how} ---- {num_slices}")

conf_mat = Confusion_mOutViT(main_path,
                num_slices,
                filtered_dict_out,
                filtered_task_dict,
                how,
...
one_off = OneOff_mOutViT(main_path,
                num_slices,
                filtered_dict_out,
                filtered_task_dict,
                how,
